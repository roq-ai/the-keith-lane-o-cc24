...
import { getFinancePartnerById } from 'apiSdk/finance-partners';
import { FinancePartnerInterface } from 'interfaces/finance-partner';

function FinancePartnerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('finance_partner', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/finance-partners/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Partnership Proposal" text={data?.partnership_proposal} />
